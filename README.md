...
3. На основе шаблона `.env.example` создайте свой собственный `.env` файл с ключевыми настройками.
...
Для доступа перейдите по ссылке [Документация API](http://127.0.0.1:8000/docs).
